// 214 Kangxi radicals — traditional forms as stored in the DB `radical` column.
// Used by RadicalSearch grid, /radical/[radical] pages, and word page detection.
export const KANGXI_RADICALS = new Set([
  '一','丨','丶','丿','乙','亅',
